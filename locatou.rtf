...
-- G\'e9n\'e9r\'e9 le :  Lun 16 Janvier 2017 \'e0 14:02\
...
\
--\
-- Structure de la table `V\'e9hicule`\
--\
\
CREATE TABLE `V\'e9hicule` (\
...
\
--\
-- Contenu de la table `V\'e9hicule`\
--\
\
INSERT INTO `V\'e9hicule` (`CodeVehicule`, `ImmatriculationVehicule`, `MiseCirculationVehicule`, `MarqueVehicule`, `ModeleVehicule`, `PuissanceVehicule`, `PrixAchatVehicule`, `DateAchatVehicule`, `PrixLocationBase`) VALUES\
...
\
--\
-- Index pour la table `V\'e9hicule`\
--\
ALTER TABLE `V\'e9hicule`\
...
--\
ALTER TABLE `Contrat`\
  MODIFY `NumeroContrat` int(11) NOT NULL AUTO_INCREMENT;\
--\
-- AUTO_INCREMENT pour la table `user`\
--\
ALTER TABLE `user`\
  MODIFY `CodeClient` int(10) NOT NULL AUTO_INCREMENT;}